...
describe FormatParser::AIFFParser do
  it 'parses an AIFF sample file' do
    parse_result = subject.information_from_io(File.open(fixtures_dir + '/AIFF/fixture.aiff', 'rb'))
  ...
  it 'parses a Logic Pro created AIFF sample file having a COMT chunk before a COMM chunk' do
    parse_result = subject.information_from_io(File.open(fixtures_dir + '/AIFF/fixture-logic-aiff.aif', 'rb'))
